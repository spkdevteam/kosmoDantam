...
const leaveRegisterSchema = mongoose.Schema({
        ...
        employeeId: { type: mongoose.Schema.ObjectId, ref: 'clientUsers', required: true, description: 'Reference to the Employee applying for leave.' },
        ...
        appliedDate: {type: Date,default: Date.now()},approvedBy: {type: mongoose.Schema.ObjectId, ref: 'Manager',},
        ...
        approverId: { type: mongoose.Schema.ObjectId, ref: 'clientUsers', description: 'Reference to the approver of the leave application.', },
